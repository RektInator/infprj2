...
def draw(game):
    ...
    button.draw(game, btn_x_off, btn_y_off(2), int(btn_width), int(btn_height), "Terug", 20,      (25,25,25), (255,255,255), lambda: game.set_state(2))
    ...
    button.draw(game, btn_x_off, btn_y_off(4), int(btn_width), int(btn_height), "Afsluiten", 20,      (25,25,25), (255,255,255), lambda: quit())
