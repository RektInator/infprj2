...
def draw(game):
    ...
    button.draw(game, btn_x_off, btn_y_off(1), int(btn_width), int(btn_height), "Start", 20,      (25,25,25), (255,255,255), lambda x: game.set_state(2))
    ...
    button.draw(game, btn_x_off, btn_y_off(4), int(btn_width), int(btn_height), "Instructies", 20,      (25,25,25), (255,255,255), lambda x: game.set_state(7))
